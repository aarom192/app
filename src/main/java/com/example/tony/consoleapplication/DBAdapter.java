...
public class DBAdapter {
    ...
    public final static String COL_NAME = "name";           // 品名
    public final static String COL_CALORIE = "calorie";     // 産地
    public final static String COL_CALORIE_MARK = "calorie_mark";      // 個数
    public final static String COL_STORE = "store";        // 単価
